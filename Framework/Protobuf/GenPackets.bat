...
XCOPY /Y Enum.pb.h "../Engine/Public"
XCOPY /Y Enum.pb.cc "../Engine/Private"

XCOPY /Y Struct.pb.h "../Engine/Public"
XCOPY /Y Struct.pb.cc "../Engine/Private"

XCOPY /Y Protocol.pb.h "../Engine/Public"
XCOPY /Y Protocol.pb.cc "../Engine/Private"
