...
BEGIN(Client)
class CAkaza_Stone_1 final : public CGameObject
{

private:
	CAkaza_Stone_1(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const wstring& strObjectTag);
	CAkaza_Stone_1(const CAkaza_Stone_1& rhs);
	virtual ~CAkaza_Stone_1() = default;
...
private:
	...
	_float m_fDeleteStartTime = 1.1f;
...
public:
	static CAkaza_Stone_1* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const wstring& strObjectTag);
