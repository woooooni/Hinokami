...
class CLevel_Train_Station final : public CLevel
{
private:
	CLevel_Train_Station(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	virtual ~CLevel_Train_Station() = default;
...
public:
	static class CLevel_Train_Station* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
