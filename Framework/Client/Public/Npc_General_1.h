...
BEGIN(Client)
class CNpc_General_1 abstract : public CGameObject
{
...
protected:
	CNpc_General_1(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const wstring& strObjectTag);
	CNpc_General_1(const CNpc_General_1& rhs);
	virtual ~CNpc_General_1() = default;
