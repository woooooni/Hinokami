...
class CState_Monster_Damaged_AirBorn final : public CState
{
private:
	CState_Monster_Damaged_AirBorn(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, class CStateMachine* pStateMachine);
