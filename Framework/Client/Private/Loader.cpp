...
HRESULT CLoader::Loading_For_Level_GamePlay()
{
	...
	if (FAILED(pGameInstance->Add_Prototype(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_Giyu"),
		CModel::Create(m_pDevice, m_pContext, CModel::TYPE_ANIM, "../Bin/Resources/Meshes/Giyu/", "Giyu.fbx", PivotMatrix))))
		return E_FAIL;
