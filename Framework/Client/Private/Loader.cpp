...
HRESULT CLoader::Loading_For_Level_GamePlay()
{
	...
	if (FAILED(pGameInstance->Add_Prototype(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_Tenshinhan"),
		CModel::Create(m_pDevice, m_pContext, CModel::TYPE_ANIM, "../Bin/Resources/Meshes/Tenshinhan/", "Tenshinhan.fbx", PivotMatrix))))
		return E_FAIL;
...
HRESULT CLoader::Loading_For_Level_Tool()
{
	...
	if (FAILED(pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_Model_Tenshinhan"),
		CModel::Create(m_pDevice, m_pContext, CModel::TYPE_ANIM, "../Bin/Resources/Meshes/Tenshinhan/", "Tenshinhan.fbx", PivotMatrix))))
		return E_FAIL;
