...
CState_Tanjiro_Basic_Idle::CState_Tanjiro_Basic_Idle(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, CTransform* pTransform, CStateMachine* pStateMachine, CModel* pModel)
...
CState_Tanjiro_Basic_Idle* CState_Tanjiro_Basic_Idle::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, CTransform* pTransform, CStateMachine* pStateMachine,
	CModel* pModel,const list<wstring>& AnimationList)
{
	CState_Tanjiro_Basic_Idle* pInstance =  new CState_Tanjiro_Basic_Idle(pDevice, pContext, pTransform, pStateMachine, pModel);
