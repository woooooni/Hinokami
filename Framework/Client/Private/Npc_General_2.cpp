...
#include "Npc_General_2.h"
#include "HierarchyNode.h"
#include "Part.h"


USING(Client)
CNpc_General_2::CNpc_General_2(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const wstring& strObjectTag)
	: CNpc(pDevice, pContext, strObjectTag, )
{
	
}

CNpc_General_2::CNpc_General_2(const CNpc_General_2& rhs)
	: CNpc(rhs)
...
HRESULT CNpc_General_2::Initialize_Prototype()
{
...
HRESULT CNpc_General_2::Initialize(void* pArg)
{
...
void CNpc_General_2::Tick(_float fTimeDelta)
{
	if (m_bReserveDead)
	{
...
void CNpc_General_2::LateTick(_float fTimeDelta)
{
...
HRESULT CNpc_General_2::Render_ShadowDepth()
{
...
void CNpc_General_2::Collision_Enter(const COLLISION_INFO& tInfo)
{

}

void CNpc_General_2::Collision_Continue(const COLLISION_INFO& tInfo)
{
...
void CNpc_General_2::Collision_Exit(const COLLISION_INFO& tInfo)
{
