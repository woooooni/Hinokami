...
USING(Client)
CAkaza_Stone_0::CAkaza_Stone_0(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const wstring& strObjectTag)
	: CGameObject(pDevice, pContext, strObjectTag, OBJ_TYPE::OBJ_EFFECT)
{
}

CAkaza_Stone_0::CAkaza_Stone_0(const CAkaza_Stone_0& rhs)
	: CGameObject(rhs)
{	
...
HRESULT CAkaza_Stone_0::Initialize_Prototype()
{
...
HRESULT CAkaza_Stone_0::Initialize(void* pArg)
{
...
void CAkaza_Stone_0::Tick(_float fTimeDelta)
{
...
void CAkaza_Stone_0::LateTick(_float fTimeDelta)
{
...
HRESULT CAkaza_Stone_0::Render_Instance(CShader* pInstancingShader, CVIBuffer_Instancing* pInstancingBuffer, const vector<_float4x4>& WorldMatrices)
{
...
HRESULT CAkaza_Stone_0::Render_Instance_Shadow(CShader* pInstancingShader, CVIBuffer_Instancing* pInstancingBuffer, const vector<_float4x4>& WorldMatrices)
{
	if (nullptr == m_pModelCom || nullptr == pInstancingShader)
		return E_FAIL;
...
HRESULT CAkaza_Stone_0::Ready_Components()
{
	...
	if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Model_Akaza_Skill_Stone_0"), TEXT("Com_Model"), (CComponent**)&m_pModelCom)))
		return E_FAIL;
...
HRESULT CAkaza_Stone_0::Ready_Colliders()
{
...
CAkaza_Stone_0* CAkaza_Stone_0::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const wstring& strObjectTag)
{
	CAkaza_Stone_0* pInstance = new CAkaza_Stone_0(pDevice, pContext, strObjectTag);
	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Create Failed : CAkaza_Stone_0");
...
CGameObject* CAkaza_Stone_0::Clone(void* pArg)
{
	CAkaza_Stone_0* pInstance = new CAkaza_Stone_0(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Cloned : CAkaza_Stone_0");
		Safe_Release(pInstance);
	}
