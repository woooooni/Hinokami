...
USING(Client)
CNpc_PoliceMan_0::CNpc_PoliceMan_0(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CNpc(pDevice, pContext, L"Npc_PoliceMan_0")
{
	
}

CNpc_PoliceMan_0::CNpc_PoliceMan_0(const CNpc_PoliceMan_0& rhs)
	: CNpc(rhs)	
...
HRESULT CNpc_PoliceMan_0::Initialize_Prototype()
{
...
HRESULT CNpc_PoliceMan_0::Initialize(void* pArg)
{
...
void CNpc_PoliceMan_0::Tick(_float fTimeDelta)
{
	if (m_bReserveDead)
	{
...
void CNpc_PoliceMan_0::LateTick(_float fTimeDelta)
{
...
HRESULT CNpc_PoliceMan_0::Render()
{
	__super::Render();
...
HRESULT CNpc_PoliceMan_0::Render_ShadowDepth()
{
...
void CNpc_PoliceMan_0::Collision_Enter(const COLLISION_INFO& tInfo)
{

}

void CNpc_PoliceMan_0::Collision_Continue(const COLLISION_INFO& tInfo)
{
...
void CNpc_PoliceMan_0::Collision_Exit(const COLLISION_INFO& tInfo)
{
...
void CNpc_PoliceMan_0::On_Damaged(CGameObject* pAttacker, _uint eDamageType, _float fDamage)
{
	__super::On_Damaged(pAttacker, eDamageType, fDamage);
}

HRESULT CNpc_PoliceMan_0::Ready_Components()
{
	/* For.Com_Transform */
...
HRESULT CNpc_PoliceMan_0::Ready_States()
{
...
HRESULT CNpc_PoliceMan_0::Ready_Colliders()
{
...
CNpc_PoliceMan_0* CNpc_PoliceMan_0::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CNpc_PoliceMan_0* pInstance = new CNpc_PoliceMan_0(pDevice, pContext);
	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Create Failed : CNpc_PoliceMan_0");
...
CGameObject* CNpc_PoliceMan_0::Clone(void* pArg)
{
	CNpc_PoliceMan_0* pInstance = new CNpc_PoliceMan_0(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Cloned : CNpc_PoliceMan_0");
		Safe_Release(pInstance);
	}
