...
CState_Kyojuro_Air_Attack::CState_Kyojuro_Air_Attack(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, CStateMachine* pStateMachine)
	: CState(pStateMachine)
{

}

HRESULT CState_Kyojuro_Air_Attack::Initialize(const list<wstring>& AnimationList)
{
...
void CState_Kyojuro_Air_Attack::Enter_State(void* pArg)
{
	m_iCurrAnimIndex = 0;
...
void CState_Kyojuro_Air_Attack::Input(_float fTimeDelta)
{
...
void CState_Kyojuro_Air_Attack::Follow_Near_Target(_float fTimeDelta)
{
...
CState_Kyojuro_Air_Attack* CState_Kyojuro_Air_Attack::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, CStateMachine* pStateMachine,const list<wstring>& AnimationList)
{
	CState_Kyojuro_Air_Attack* pInstance =  new CState_Kyojuro_Air_Attack(pDevice, pContext, pStateMachine);
	if (FAILED(pInstance->Initialize(AnimationList)))
	{
		Safe_Release(pInstance);
		MSG_BOX("Failed Create : CState_Kyojuro_Air_Attack");
		return nullptr;
	}
...
void CState_Kyojuro_Air_Attack::Free()
{
	__super::Free();
}
