...
_bool CEffect_Manager::Is_Picking(CTransform* pTransform, CVIBuffer* pBuffer, _bool bCutPos, _float4* vOut)
{
...
_bool CEffect_Manager::Is_NaviPicking(CTransform* pTransform, CVIBuffer* pBuffer, _float3* pWorldOut, _float3* pLocalPos)
{
	if (nullptr == pTransform)
		return false;
