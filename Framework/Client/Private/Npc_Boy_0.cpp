...
USING(Client)
CNpc_Boy_0::CNpc_Boy_0(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CNpc(pDevice, pContext, L"Npc_Boy_0")
{
	
}

CNpc_Boy_0::CNpc_Boy_0(const CNpc_Boy_0& rhs)
	: CNpc(rhs)	
...
HRESULT CNpc_Boy_0::Initialize_Prototype()
{
...
HRESULT CNpc_Boy_0::Initialize(void* pArg)
{
...
void CNpc_Boy_0::Tick(_float fTimeDelta)
{
	if (m_bReserveDead)
	{
...
void CNpc_Boy_0::LateTick(_float fTimeDelta)
{
...
HRESULT CNpc_Boy_0::Render_ShadowDepth()
{
...
void CNpc_Boy_0::Collision_Enter(const COLLISION_INFO& tInfo)
{

}

void CNpc_Boy_0::Collision_Continue(const COLLISION_INFO& tInfo)
{
...
void CNpc_Boy_0::Collision_Exit(const COLLISION_INFO& tInfo)
{
...
void CNpc_Boy_0::On_Damaged(CGameObject* pAttacker, _uint eDamageType, _float fDamage)
{
	__super::On_Damaged(pAttacker, eDamageType, fDamage);
}

HRESULT CNpc_Boy_0::Ready_Components()
{
	/* For.Com_Transform */
...
HRESULT CNpc_Boy_0::Ready_States()
{
...
HRESULT CNpc_Boy_0::Ready_Colliders()
{
...
CNpc_Boy_0* CNpc_Boy_0::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CNpc_Boy_0* pInstance = new CNpc_Boy_0(pDevice, pContext);
...
CGameObject* CNpc_Boy_0::Clone(void* pArg)
{
	CNpc_Boy_0* pInstance = new CNpc_Boy_0(*this);
