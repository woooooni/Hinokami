...
USING(Client)
CNpc_Girl_1::CNpc_Girl_1(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CNpc(pDevice, pContext, L"Npc_Girl_1")
{
	
}

CNpc_Girl_1::CNpc_Girl_1(const CNpc_Girl_1& rhs)
	: CNpc(rhs)	
...
HRESULT CNpc_Girl_1::Initialize_Prototype()
{
...
HRESULT CNpc_Girl_1::Initialize(void* pArg)
{
...
void CNpc_Girl_1::Tick(_float fTimeDelta)
{
	if (m_bReserveDead)
	{
...
void CNpc_Girl_1::LateTick(_float fTimeDelta)
{
...
HRESULT CNpc_Girl_1::Render_ShadowDepth()
{
...
void CNpc_Girl_1::Collision_Enter(const COLLISION_INFO& tInfo)
{

}

void CNpc_Girl_1::Collision_Continue(const COLLISION_INFO& tInfo)
{
...
void CNpc_Girl_1::Collision_Exit(const COLLISION_INFO& tInfo)
{
...
void CNpc_Girl_1::On_Damaged(CGameObject* pAttacker, _uint eDamageType, _float fDamage)
{
	__super::On_Damaged(pAttacker, eDamageType, fDamage);
}

HRESULT CNpc_Girl_1::Ready_Components()
{
	/* For.Com_Transform */
...
HRESULT CNpc_Girl_1::Ready_States()
{
...
HRESULT CNpc_Girl_1::Ready_Colliders()
{
...
CNpc_Girl_1* CNpc_Girl_1::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CNpc_Girl_1* pInstance = new CNpc_Girl_1(pDevice, pContext);
	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Create Failed : CNpc_Girl_1");
...
CGameObject* CNpc_Girl_1::Clone(void* pArg)
{
	CNpc_Girl_1* pInstance = new CNpc_Girl_1(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Cloned : CNpc_Girl_1");
		Safe_Release(pInstance);
	}
