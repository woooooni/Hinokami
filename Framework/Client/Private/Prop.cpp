...
HRESULT CProp::Render(CVIBuffer_Instancing* pInstanceBuffer, const vector<_float4x4>& WorldMatrices)
{
...
HRESULT CProp::Render_ShadowDepth(CVIBuffer_Instancing* pBufferInstance, const vector<_float4x4>& WorldMatrices)
{
