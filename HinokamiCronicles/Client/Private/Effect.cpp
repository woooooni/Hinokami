...
HRESULT CEffect::Initialize(void * pArg)
{
	...
	m_pTransformCom->Set_State(CTransform::STATE_POSITION, XMVectorSet(rand() % 10, 1.3f, rand() % 10, 1.f));
...
HRESULT CEffect::Render()
{
	...
	if (FAILED(m_pTextureCom->Set_SRV(m_pShaderCom, "g_DiffuseTexture", m_fFrame)))
		return E_FAIL;
